...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static final long NEXT_SCAN_DELAY_MS = 2000L;
...
//        resultView = findViewById(R.id.result_view);
    ...
    //Final Decode Result @Dibkar Mistry
    // Put up our own UI for how to handle the decoded contents.
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {

        BarcodeFormat format = rawResult.getBarcodeFormat();
        String decodeString = rawResult.getText();
        long timestamp = rawResult.getTimestamp();

        Toast.makeText(this, decodeString, Toast.LENGTH_SHORT).show();
        //Delay For Next Scanning
